...
const serverUrl = "https://lkitiyytiig4.usemoralis.com:2053/server"; //Moralis Server Url here
const appId = "kiLNcDCGCC2wnXlgX5O8QfJOMVtaMFJGDuo4hKk6"; //Moralis Server App ID here
