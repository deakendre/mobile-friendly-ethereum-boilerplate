...
function InputForm() {
  ...
  //const abi = [nft_abi];
  const contractAddress = '0xB799dead4Da8D3E6C6E9124957964e76aD123529';
  ...
  async function createnft() {
    ...
    if (user) {
      ...
      if (_metadataHash) {
        setResultmsg('3/3: mint to Polygon Mumbai testnet (sign in wallet)...');
        ...
        let url = `https://mumbai.polygonscan.com/tx/${token_address}`;
