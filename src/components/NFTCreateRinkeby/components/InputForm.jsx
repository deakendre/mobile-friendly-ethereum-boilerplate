...
const styles = {
  ...
  textWrapper: { maxWidth: "100%", width: "500%" },
  row: {
    display: "flex",
    alignItems: "center",
    gap: "10px",
...
function InputForm() {
  ...
  async function createnft() {
    ...
    if (user) {
      ...
      if (!_metadataHash) {
        setResultmsg('1/3: salvataggio immagine su IPFS e creazione metadata...');
        ...
        setResultmsg('2/3: caricamento metadata su IPFS...');
      ...
      if (_metadataHash) {
        setResultmsg('3/3: lazy minting verso Rarible (connessione wallet)...');
    ...
    <div style={styles.card}>
      <div style={styles.inputform}>
        <div style={styles.select}>
          ...
          <Input size="large" yarautoFocus onChange={(e) => {setNftName(`${e.target.value}`); }} disabled={isPending} />
        </div>
        <div style={styles.select}>
          <div style={styles.textWrapper}>
