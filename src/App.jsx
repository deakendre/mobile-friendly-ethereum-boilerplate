...
import Sidebarlol from "/home/endre/Desktop/BackupWEB3DevsIta/provastrana/ethereum-nft-marketplace-boilerplate/src/components/Sidebarlol/App.js"
import Navbar from "components/Sidebarlol/components/Navbar";
...
const styles = {
  content: {
    //backgroundColor: "#fff",
    backgroundImage: "linear-gradient(#000, #ebebeb)",
    display: "flex",
  ...
  return (
    <Layout style={{ height: "100vh", overflow: "auto" }}> 
      ...
      <Router>
        ...
        <div style={{
          display: "flex", position: "relative", zIndex: 10, height: 100, width: "100%", backgroundColor: "black", justifyContent: "space-between"
        }}>
            <Account />
      ...
      <Footer style={{ textAlign: "center", backgroundColor: "#000", height: "200px"}}>
        <Text style={{ color: "white", fontFamily: "helvetica", fontSize: "30px",  position: "relative"}}> WEB3 DEVS ITALIA 🇮🇹 </Text>
      </Footer>
    </Layout>
  );
};
